...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'border-2 border-purple-400 bg-white text-purple-700 hover:border-purple-500 hover:bg-purple-50 focus:ring-purple-500 shadow-sm hover:shadow-md',
